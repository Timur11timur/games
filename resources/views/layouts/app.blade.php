    ...
    <header class="border-b border-gray-800">
        <nav class="container mx-auto flex items-center justify-between px-4 py-6">
            <div class="flex items-center">
                <a href="/" class="-my-2">
                    <img src="/logo.svg" alt="logo" class="w-12 flex-none">
                </a>
            ...
            <div class="flex items-center">
                <div class="relative">
                    <input type="text" class="bg-gray-800 text-sm rounded-full focus:outline-none focus:ring w-64 px-3 pl-8 py-1" placeholder="Search...">
